...
_libnuml.NUML_CONSTRAINT_swigconstant(_libnuml)
NUML_CONSTRAINT = _libnuml.NUML_CONSTRAINT
...
class XMLNode(XMLToken):
    ...
    def equals(self, other, ignoreURI=False):
        ...
        """
        return _libnuml.XMLNode_equals(self, other, ignoreURI)
...
_libnuml.AST_PLUS_swigconstant(_libnuml)
AST_PLUS = _libnuml.AST_PLUS

_libnuml.AST_MINUS_swigconstant(_libnuml)
AST_MINUS = _libnuml.AST_MINUS

_libnuml.AST_TIMES_swigconstant(_libnuml)
AST_TIMES = _libnuml.AST_TIMES

_libnuml.AST_DIVIDE_swigconstant(_libnuml)
AST_DIVIDE = _libnuml.AST_DIVIDE

_libnuml.AST_POWER_swigconstant(_libnuml)
AST_POWER = _libnuml.AST_POWER

_libnuml.AST_INTEGER_swigconstant(_libnuml)
AST_INTEGER = _libnuml.AST_INTEGER

_libnuml.AST_REAL_swigconstant(_libnuml)
AST_REAL = _libnuml.AST_REAL

_libnuml.AST_REAL_E_swigconstant(_libnuml)
AST_REAL_E = _libnuml.AST_REAL_E

_libnuml.AST_RATIONAL_swigconstant(_libnuml)
AST_RATIONAL = _libnuml.AST_RATIONAL

_libnuml.AST_NAME_swigconstant(_libnuml)
AST_NAME = _libnuml.AST_NAME

_libnuml.AST_NAME_AVOGADRO_swigconstant(_libnuml)
AST_NAME_AVOGADRO = _libnuml.AST_NAME_AVOGADRO

_libnuml.AST_NAME_TIME_swigconstant(_libnuml)
AST_NAME_TIME = _libnuml.AST_NAME_TIME

_libnuml.AST_CONSTANT_E_swigconstant(_libnuml)
AST_CONSTANT_E = _libnuml.AST_CONSTANT_E

_libnuml.AST_CONSTANT_FALSE_swigconstant(_libnuml)
AST_CONSTANT_FALSE = _libnuml.AST_CONSTANT_FALSE

_libnuml.AST_CONSTANT_PI_swigconstant(_libnuml)
AST_CONSTANT_PI = _libnuml.AST_CONSTANT_PI

_libnuml.AST_CONSTANT_TRUE_swigconstant(_libnuml)
AST_CONSTANT_TRUE = _libnuml.AST_CONSTANT_TRUE

_libnuml.AST_LAMBDA_swigconstant(_libnuml)
AST_LAMBDA = _libnuml.AST_LAMBDA

_libnuml.AST_FUNCTION_swigconstant(_libnuml)
AST_FUNCTION = _libnuml.AST_FUNCTION

_libnuml.AST_FUNCTION_ABS_swigconstant(_libnuml)
AST_FUNCTION_ABS = _libnuml.AST_FUNCTION_ABS

_libnuml.AST_FUNCTION_ARCCOS_swigconstant(_libnuml)
AST_FUNCTION_ARCCOS = _libnuml.AST_FUNCTION_ARCCOS

_libnuml.AST_FUNCTION_ARCCOSH_swigconstant(_libnuml)
AST_FUNCTION_ARCCOSH = _libnuml.AST_FUNCTION_ARCCOSH

_libnuml.AST_FUNCTION_ARCCOT_swigconstant(_libnuml)
AST_FUNCTION_ARCCOT = _libnuml.AST_FUNCTION_ARCCOT

_libnuml.AST_FUNCTION_ARCCOTH_swigconstant(_libnuml)
AST_FUNCTION_ARCCOTH = _libnuml.AST_FUNCTION_ARCCOTH

_libnuml.AST_FUNCTION_ARCCSC_swigconstant(_libnuml)
AST_FUNCTION_ARCCSC = _libnuml.AST_FUNCTION_ARCCSC

_libnuml.AST_FUNCTION_ARCCSCH_swigconstant(_libnuml)
AST_FUNCTION_ARCCSCH = _libnuml.AST_FUNCTION_ARCCSCH

_libnuml.AST_FUNCTION_ARCSEC_swigconstant(_libnuml)
AST_FUNCTION_ARCSEC = _libnuml.AST_FUNCTION_ARCSEC

_libnuml.AST_FUNCTION_ARCSECH_swigconstant(_libnuml)
AST_FUNCTION_ARCSECH = _libnuml.AST_FUNCTION_ARCSECH

_libnuml.AST_FUNCTION_ARCSIN_swigconstant(_libnuml)
AST_FUNCTION_ARCSIN = _libnuml.AST_FUNCTION_ARCSIN

_libnuml.AST_FUNCTION_ARCSINH_swigconstant(_libnuml)
AST_FUNCTION_ARCSINH = _libnuml.AST_FUNCTION_ARCSINH

_libnuml.AST_FUNCTION_ARCTAN_swigconstant(_libnuml)
AST_FUNCTION_ARCTAN = _libnuml.AST_FUNCTION_ARCTAN

_libnuml.AST_FUNCTION_ARCTANH_swigconstant(_libnuml)
AST_FUNCTION_ARCTANH = _libnuml.AST_FUNCTION_ARCTANH

_libnuml.AST_FUNCTION_CEILING_swigconstant(_libnuml)
AST_FUNCTION_CEILING = _libnuml.AST_FUNCTION_CEILING

_libnuml.AST_FUNCTION_COS_swigconstant(_libnuml)
AST_FUNCTION_COS = _libnuml.AST_FUNCTION_COS

_libnuml.AST_FUNCTION_COSH_swigconstant(_libnuml)
AST_FUNCTION_COSH = _libnuml.AST_FUNCTION_COSH

_libnuml.AST_FUNCTION_COT_swigconstant(_libnuml)
AST_FUNCTION_COT = _libnuml.AST_FUNCTION_COT

_libnuml.AST_FUNCTION_COTH_swigconstant(_libnuml)
AST_FUNCTION_COTH = _libnuml.AST_FUNCTION_COTH

_libnuml.AST_FUNCTION_CSC_swigconstant(_libnuml)
AST_FUNCTION_CSC = _libnuml.AST_FUNCTION_CSC

_libnuml.AST_FUNCTION_CSCH_swigconstant(_libnuml)
AST_FUNCTION_CSCH = _libnuml.AST_FUNCTION_CSCH

_libnuml.AST_FUNCTION_DELAY_swigconstant(_libnuml)
AST_FUNCTION_DELAY = _libnuml.AST_FUNCTION_DELAY

_libnuml.AST_FUNCTION_EXP_swigconstant(_libnuml)
AST_FUNCTION_EXP = _libnuml.AST_FUNCTION_EXP

_libnuml.AST_FUNCTION_FACTORIAL_swigconstant(_libnuml)
AST_FUNCTION_FACTORIAL = _libnuml.AST_FUNCTION_FACTORIAL

_libnuml.AST_FUNCTION_FLOOR_swigconstant(_libnuml)
AST_FUNCTION_FLOOR = _libnuml.AST_FUNCTION_FLOOR

_libnuml.AST_FUNCTION_LN_swigconstant(_libnuml)
AST_FUNCTION_LN = _libnuml.AST_FUNCTION_LN

_libnuml.AST_FUNCTION_LOG_swigconstant(_libnuml)
AST_FUNCTION_LOG = _libnuml.AST_FUNCTION_LOG

_libnuml.AST_FUNCTION_PIECEWISE_swigconstant(_libnuml)
AST_FUNCTION_PIECEWISE = _libnuml.AST_FUNCTION_PIECEWISE

_libnuml.AST_FUNCTION_POWER_swigconstant(_libnuml)
AST_FUNCTION_POWER = _libnuml.AST_FUNCTION_POWER

_libnuml.AST_FUNCTION_ROOT_swigconstant(_libnuml)
AST_FUNCTION_ROOT = _libnuml.AST_FUNCTION_ROOT

_libnuml.AST_FUNCTION_SEC_swigconstant(_libnuml)
AST_FUNCTION_SEC = _libnuml.AST_FUNCTION_SEC

_libnuml.AST_FUNCTION_SECH_swigconstant(_libnuml)
AST_FUNCTION_SECH = _libnuml.AST_FUNCTION_SECH

_libnuml.AST_FUNCTION_SIN_swigconstant(_libnuml)
AST_FUNCTION_SIN = _libnuml.AST_FUNCTION_SIN

_libnuml.AST_FUNCTION_SINH_swigconstant(_libnuml)
AST_FUNCTION_SINH = _libnuml.AST_FUNCTION_SINH

_libnuml.AST_FUNCTION_TAN_swigconstant(_libnuml)
AST_FUNCTION_TAN = _libnuml.AST_FUNCTION_TAN

_libnuml.AST_FUNCTION_TANH_swigconstant(_libnuml)
AST_FUNCTION_TANH = _libnuml.AST_FUNCTION_TANH

_libnuml.AST_LOGICAL_AND_swigconstant(_libnuml)
AST_LOGICAL_AND = _libnuml.AST_LOGICAL_AND

_libnuml.AST_LOGICAL_NOT_swigconstant(_libnuml)
AST_LOGICAL_NOT = _libnuml.AST_LOGICAL_NOT

_libnuml.AST_LOGICAL_OR_swigconstant(_libnuml)
AST_LOGICAL_OR = _libnuml.AST_LOGICAL_OR

_libnuml.AST_LOGICAL_XOR_swigconstant(_libnuml)
AST_LOGICAL_XOR = _libnuml.AST_LOGICAL_XOR

_libnuml.AST_RELATIONAL_EQ_swigconstant(_libnuml)
AST_RELATIONAL_EQ = _libnuml.AST_RELATIONAL_EQ

_libnuml.AST_RELATIONAL_GEQ_swigconstant(_libnuml)
AST_RELATIONAL_GEQ = _libnuml.AST_RELATIONAL_GEQ

_libnuml.AST_RELATIONAL_GT_swigconstant(_libnuml)
AST_RELATIONAL_GT = _libnuml.AST_RELATIONAL_GT

_libnuml.AST_RELATIONAL_LEQ_swigconstant(_libnuml)
AST_RELATIONAL_LEQ = _libnuml.AST_RELATIONAL_LEQ

_libnuml.AST_RELATIONAL_LT_swigconstant(_libnuml)
AST_RELATIONAL_LT = _libnuml.AST_RELATIONAL_LT

_libnuml.AST_RELATIONAL_NEQ_swigconstant(_libnuml)
AST_RELATIONAL_NEQ = _libnuml.AST_RELATIONAL_NEQ

_libnuml.AST_FUNCTION_MAX_swigconstant(_libnuml)
AST_FUNCTION_MAX = _libnuml.AST_FUNCTION_MAX

_libnuml.AST_FUNCTION_MIN_swigconstant(_libnuml)
AST_FUNCTION_MIN = _libnuml.AST_FUNCTION_MIN

_libnuml.AST_FUNCTION_QUOTIENT_swigconstant(_libnuml)
AST_FUNCTION_QUOTIENT = _libnuml.AST_FUNCTION_QUOTIENT

_libnuml.AST_FUNCTION_RATE_OF_swigconstant(_libnuml)
AST_FUNCTION_RATE_OF = _libnuml.AST_FUNCTION_RATE_OF

_libnuml.AST_FUNCTION_REM_swigconstant(_libnuml)
AST_FUNCTION_REM = _libnuml.AST_FUNCTION_REM

_libnuml.AST_LOGICAL_IMPLIES_swigconstant(_libnuml)
AST_LOGICAL_IMPLIES = _libnuml.AST_LOGICAL_IMPLIES

_libnuml.AST_CSYMBOL_FUNCTION_swigconstant(_libnuml)
AST_CSYMBOL_FUNCTION = _libnuml.AST_CSYMBOL_FUNCTION

_libnuml.AST_UNKNOWN_swigconstant(_libnuml)
AST_UNKNOWN = _libnuml.AST_UNKNOWN

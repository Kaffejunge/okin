...
_libcombine.AST_PLUS_swigconstant(_libcombine)
AST_PLUS = _libcombine.AST_PLUS

_libcombine.AST_MINUS_swigconstant(_libcombine)
AST_MINUS = _libcombine.AST_MINUS

_libcombine.AST_TIMES_swigconstant(_libcombine)
AST_TIMES = _libcombine.AST_TIMES

_libcombine.AST_DIVIDE_swigconstant(_libcombine)
AST_DIVIDE = _libcombine.AST_DIVIDE

_libcombine.AST_POWER_swigconstant(_libcombine)
AST_POWER = _libcombine.AST_POWER

_libcombine.AST_INTEGER_swigconstant(_libcombine)
AST_INTEGER = _libcombine.AST_INTEGER

_libcombine.AST_REAL_swigconstant(_libcombine)
AST_REAL = _libcombine.AST_REAL

_libcombine.AST_REAL_E_swigconstant(_libcombine)
AST_REAL_E = _libcombine.AST_REAL_E

_libcombine.AST_RATIONAL_swigconstant(_libcombine)
AST_RATIONAL = _libcombine.AST_RATIONAL

_libcombine.AST_NAME_swigconstant(_libcombine)
AST_NAME = _libcombine.AST_NAME

_libcombine.AST_NAME_AVOGADRO_swigconstant(_libcombine)
AST_NAME_AVOGADRO = _libcombine.AST_NAME_AVOGADRO

_libcombine.AST_NAME_TIME_swigconstant(_libcombine)
AST_NAME_TIME = _libcombine.AST_NAME_TIME

_libcombine.AST_CONSTANT_E_swigconstant(_libcombine)
AST_CONSTANT_E = _libcombine.AST_CONSTANT_E

_libcombine.AST_CONSTANT_FALSE_swigconstant(_libcombine)
AST_CONSTANT_FALSE = _libcombine.AST_CONSTANT_FALSE

_libcombine.AST_CONSTANT_PI_swigconstant(_libcombine)
AST_CONSTANT_PI = _libcombine.AST_CONSTANT_PI

_libcombine.AST_CONSTANT_TRUE_swigconstant(_libcombine)
AST_CONSTANT_TRUE = _libcombine.AST_CONSTANT_TRUE

_libcombine.AST_LAMBDA_swigconstant(_libcombine)
AST_LAMBDA = _libcombine.AST_LAMBDA

_libcombine.AST_FUNCTION_swigconstant(_libcombine)
AST_FUNCTION = _libcombine.AST_FUNCTION

_libcombine.AST_FUNCTION_ABS_swigconstant(_libcombine)
AST_FUNCTION_ABS = _libcombine.AST_FUNCTION_ABS

_libcombine.AST_FUNCTION_ARCCOS_swigconstant(_libcombine)
AST_FUNCTION_ARCCOS = _libcombine.AST_FUNCTION_ARCCOS

_libcombine.AST_FUNCTION_ARCCOSH_swigconstant(_libcombine)
AST_FUNCTION_ARCCOSH = _libcombine.AST_FUNCTION_ARCCOSH

_libcombine.AST_FUNCTION_ARCCOT_swigconstant(_libcombine)
AST_FUNCTION_ARCCOT = _libcombine.AST_FUNCTION_ARCCOT

_libcombine.AST_FUNCTION_ARCCOTH_swigconstant(_libcombine)
AST_FUNCTION_ARCCOTH = _libcombine.AST_FUNCTION_ARCCOTH

_libcombine.AST_FUNCTION_ARCCSC_swigconstant(_libcombine)
AST_FUNCTION_ARCCSC = _libcombine.AST_FUNCTION_ARCCSC

_libcombine.AST_FUNCTION_ARCCSCH_swigconstant(_libcombine)
AST_FUNCTION_ARCCSCH = _libcombine.AST_FUNCTION_ARCCSCH

_libcombine.AST_FUNCTION_ARCSEC_swigconstant(_libcombine)
AST_FUNCTION_ARCSEC = _libcombine.AST_FUNCTION_ARCSEC

_libcombine.AST_FUNCTION_ARCSECH_swigconstant(_libcombine)
AST_FUNCTION_ARCSECH = _libcombine.AST_FUNCTION_ARCSECH

_libcombine.AST_FUNCTION_ARCSIN_swigconstant(_libcombine)
AST_FUNCTION_ARCSIN = _libcombine.AST_FUNCTION_ARCSIN

_libcombine.AST_FUNCTION_ARCSINH_swigconstant(_libcombine)
AST_FUNCTION_ARCSINH = _libcombine.AST_FUNCTION_ARCSINH

_libcombine.AST_FUNCTION_ARCTAN_swigconstant(_libcombine)
AST_FUNCTION_ARCTAN = _libcombine.AST_FUNCTION_ARCTAN

_libcombine.AST_FUNCTION_ARCTANH_swigconstant(_libcombine)
AST_FUNCTION_ARCTANH = _libcombine.AST_FUNCTION_ARCTANH

_libcombine.AST_FUNCTION_CEILING_swigconstant(_libcombine)
AST_FUNCTION_CEILING = _libcombine.AST_FUNCTION_CEILING

_libcombine.AST_FUNCTION_COS_swigconstant(_libcombine)
AST_FUNCTION_COS = _libcombine.AST_FUNCTION_COS

_libcombine.AST_FUNCTION_COSH_swigconstant(_libcombine)
AST_FUNCTION_COSH = _libcombine.AST_FUNCTION_COSH

_libcombine.AST_FUNCTION_COT_swigconstant(_libcombine)
AST_FUNCTION_COT = _libcombine.AST_FUNCTION_COT

_libcombine.AST_FUNCTION_COTH_swigconstant(_libcombine)
AST_FUNCTION_COTH = _libcombine.AST_FUNCTION_COTH

_libcombine.AST_FUNCTION_CSC_swigconstant(_libcombine)
AST_FUNCTION_CSC = _libcombine.AST_FUNCTION_CSC

_libcombine.AST_FUNCTION_CSCH_swigconstant(_libcombine)
AST_FUNCTION_CSCH = _libcombine.AST_FUNCTION_CSCH

_libcombine.AST_FUNCTION_DELAY_swigconstant(_libcombine)
AST_FUNCTION_DELAY = _libcombine.AST_FUNCTION_DELAY

_libcombine.AST_FUNCTION_EXP_swigconstant(_libcombine)
AST_FUNCTION_EXP = _libcombine.AST_FUNCTION_EXP

_libcombine.AST_FUNCTION_FACTORIAL_swigconstant(_libcombine)
AST_FUNCTION_FACTORIAL = _libcombine.AST_FUNCTION_FACTORIAL

_libcombine.AST_FUNCTION_FLOOR_swigconstant(_libcombine)
AST_FUNCTION_FLOOR = _libcombine.AST_FUNCTION_FLOOR

_libcombine.AST_FUNCTION_LN_swigconstant(_libcombine)
AST_FUNCTION_LN = _libcombine.AST_FUNCTION_LN

_libcombine.AST_FUNCTION_LOG_swigconstant(_libcombine)
AST_FUNCTION_LOG = _libcombine.AST_FUNCTION_LOG

_libcombine.AST_FUNCTION_PIECEWISE_swigconstant(_libcombine)
AST_FUNCTION_PIECEWISE = _libcombine.AST_FUNCTION_PIECEWISE

_libcombine.AST_FUNCTION_POWER_swigconstant(_libcombine)
AST_FUNCTION_POWER = _libcombine.AST_FUNCTION_POWER

_libcombine.AST_FUNCTION_ROOT_swigconstant(_libcombine)
AST_FUNCTION_ROOT = _libcombine.AST_FUNCTION_ROOT

_libcombine.AST_FUNCTION_SEC_swigconstant(_libcombine)
AST_FUNCTION_SEC = _libcombine.AST_FUNCTION_SEC

_libcombine.AST_FUNCTION_SECH_swigconstant(_libcombine)
AST_FUNCTION_SECH = _libcombine.AST_FUNCTION_SECH

_libcombine.AST_FUNCTION_SIN_swigconstant(_libcombine)
AST_FUNCTION_SIN = _libcombine.AST_FUNCTION_SIN

_libcombine.AST_FUNCTION_SINH_swigconstant(_libcombine)
AST_FUNCTION_SINH = _libcombine.AST_FUNCTION_SINH

_libcombine.AST_FUNCTION_TAN_swigconstant(_libcombine)
AST_FUNCTION_TAN = _libcombine.AST_FUNCTION_TAN

_libcombine.AST_FUNCTION_TANH_swigconstant(_libcombine)
AST_FUNCTION_TANH = _libcombine.AST_FUNCTION_TANH

_libcombine.AST_LOGICAL_AND_swigconstant(_libcombine)
AST_LOGICAL_AND = _libcombine.AST_LOGICAL_AND

_libcombine.AST_LOGICAL_NOT_swigconstant(_libcombine)
AST_LOGICAL_NOT = _libcombine.AST_LOGICAL_NOT

_libcombine.AST_LOGICAL_OR_swigconstant(_libcombine)
AST_LOGICAL_OR = _libcombine.AST_LOGICAL_OR

_libcombine.AST_LOGICAL_XOR_swigconstant(_libcombine)
AST_LOGICAL_XOR = _libcombine.AST_LOGICAL_XOR

_libcombine.AST_RELATIONAL_EQ_swigconstant(_libcombine)
AST_RELATIONAL_EQ = _libcombine.AST_RELATIONAL_EQ

_libcombine.AST_RELATIONAL_GEQ_swigconstant(_libcombine)
AST_RELATIONAL_GEQ = _libcombine.AST_RELATIONAL_GEQ

_libcombine.AST_RELATIONAL_GT_swigconstant(_libcombine)
AST_RELATIONAL_GT = _libcombine.AST_RELATIONAL_GT

_libcombine.AST_RELATIONAL_LEQ_swigconstant(_libcombine)
AST_RELATIONAL_LEQ = _libcombine.AST_RELATIONAL_LEQ

_libcombine.AST_RELATIONAL_LT_swigconstant(_libcombine)
AST_RELATIONAL_LT = _libcombine.AST_RELATIONAL_LT

_libcombine.AST_RELATIONAL_NEQ_swigconstant(_libcombine)
AST_RELATIONAL_NEQ = _libcombine.AST_RELATIONAL_NEQ

_libcombine.AST_FUNCTION_MAX_swigconstant(_libcombine)
AST_FUNCTION_MAX = _libcombine.AST_FUNCTION_MAX

_libcombine.AST_FUNCTION_MIN_swigconstant(_libcombine)
AST_FUNCTION_MIN = _libcombine.AST_FUNCTION_MIN

_libcombine.AST_FUNCTION_QUOTIENT_swigconstant(_libcombine)
AST_FUNCTION_QUOTIENT = _libcombine.AST_FUNCTION_QUOTIENT

_libcombine.AST_FUNCTION_RATE_OF_swigconstant(_libcombine)
AST_FUNCTION_RATE_OF = _libcombine.AST_FUNCTION_RATE_OF

_libcombine.AST_FUNCTION_REM_swigconstant(_libcombine)
AST_FUNCTION_REM = _libcombine.AST_FUNCTION_REM

_libcombine.AST_LOGICAL_IMPLIES_swigconstant(_libcombine)
AST_LOGICAL_IMPLIES = _libcombine.AST_LOGICAL_IMPLIES

_libcombine.AST_CSYMBOL_FUNCTION_swigconstant(_libcombine)
AST_CSYMBOL_FUNCTION = _libcombine.AST_CSYMBOL_FUNCTION

_libcombine.AST_UNKNOWN_swigconstant(_libcombine)
...
class L3ParserSettings(_object):
    ...
    def visitPackageInfixSyntax(self, parent, node, sb):
        """visitPackageInfixSyntax(L3ParserSettings self, ASTNode_t const * parent, ASTNode_t const * node, StringBuffer_t * sb)"""
...
_libcombine.CaUnknownError_swigconstant(_libcombine)
CaUnknownError = _libcombine.CaUnknownError
...
_libcombine.CombineCaContentAllowedCoreAttributes_swigconstant(_libcombine)
CombineCaContentAllowedCoreAttributes = _libcombine.CombineCaContentAllowedCoreAttributes

_libcombine.CombineCaContentAllowedCoreElements_swigconstant(_libcombine)
CombineCaContentAllowedCoreElements = _libcombine.CombineCaContentAllowedCoreElements

_libcombine.CombineCaContentAllowedAttributes_swigconstant(_libcombine)
CombineCaContentAllowedAttributes = _libcombine.CombineCaContentAllowedAttributes

_libcombine.CombineCaContentLocationMustBeString_swigconstant(_libcombine)
CombineCaContentLocationMustBeString = _libcombine.CombineCaContentLocationMustBeString

_libcombine.CombineCaContentFormatMustBeString_swigconstant(_libcombine)
CombineCaContentFormatMustBeString = _libcombine.CombineCaContentFormatMustBeString

_libcombine.CombineCaContentMasterMustBeBoolean_swigconstant(_libcombine)
CombineCaContentMasterMustBeBoolean = _libcombine.CombineCaContentMasterMustBeBoolean

_libcombine.CombineCaOmexManifestAllowedCoreAttributes_swigconstant(_libcombine)
CombineCaOmexManifestAllowedCoreAttributes = _libcombine.CombineCaOmexManifestAllowedCoreAttributes

_libcombine.CombineCaOmexManifestAllowedCoreElements_swigconstant(_libcombine)
CombineCaOmexManifestAllowedCoreElements = _libcombine.CombineCaOmexManifestAllowedCoreElements

_libcombine.CombineCaOmexManifestAllowedElements_swigconstant(_libcombine)
CombineCaOmexManifestAllowedElements = _libcombine.CombineCaOmexManifestAllowedElements

_libcombine.CombineCaOmexManifestLOContentsAllowedCoreElements_swigconstant(_libcombine)
CombineCaOmexManifestLOContentsAllowedCoreElements = _libcombine.CombineCaOmexManifestLOContentsAllowedCoreElements

_libcombine.CombineCaOmexManifestLOContentsAllowedCoreAttributes_swigconstant(_libcombine)
CombineCaOmexManifestLOContentsAllowedCoreAttributes = _libcombine.CombineCaOmexManifestLOContentsAllowedCoreAttributes

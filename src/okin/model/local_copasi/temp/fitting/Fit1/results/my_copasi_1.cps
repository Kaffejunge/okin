<COPASI xmlns="http://www.copasi.org/static/schema" versionMajor="4" versionMinor="34" versionDevel="251" copasiSourcesModified="0">
  ...
  <Model key="Model_1" name="NoName" simulationType="time" timeUnit="s" volumeUnit="l" areaUnit="m&#178;" lengthUnit="m" quantityUnit="mol" type="deterministic" avogadroConstant="6.0221417899999999e+23">
    ...
    <ListOfMetabolites>
      ...
      <Metabolite key="Metabolite_1" name="cat" simulationType="reactions" compartment="Compartment_0" addNoise="false" particle_numbers="0.0">
        <MiriamAnnotation>
          <rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
      ...
      <Metabolite key="Metabolite_3" name="B" simulationType="reactions" compartment="Compartment_0" addNoise="false" particle_numbers="0.0">
        <MiriamAnnotation>
          <rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
      ...
      <Metabolite key="Metabolite_4" name="P" simulationType="reactions" compartment="Compartment_0" addNoise="false" particle_numbers="0.0">
        <MiriamAnnotation>
          <rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
    ...
    <ListOfModelValues>
      <ModelValue key="ModelValue_0" name="k1" simulationType="fixed" addNoise="false" initial_value="49941.0">
        <MiriamAnnotation>
          <rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
      ...
      <ModelValue key="ModelValue_1" name="kN1" simulationType="fixed" addNoise="false" initial_value="79097.0">
        <MiriamAnnotation>
          <rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
      ...
      <ModelValue key="ModelValue_2" name="k2" simulationType="fixed" addNoise="false" initial_value="74286.0">
        <MiriamAnnotation>
          <rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
      ...
      <ModelValue key="ModelValue_3" name="kN2" simulationType="fixed" addNoise="false" initial_value="16290.0">
        <MiriamAnnotation>
          <rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
      ...
      <ModelValue key="ModelValue_4" name="k3" simulationType="fixed" addNoise="false" initial_value="31655.0">
        <MiriamAnnotation>
          <rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
      ...
      <ModelValue key="ModelValue_5" name="kN3" simulationType="fixed" addNoise="false" initial_value="49340.0">
        <MiriamAnnotation>
          <rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
    ...
    <InitialState type="initialState">
      0 0 0 0 0 0 0 1 49941 79097 74286 16290 31655 49340 
    </InitialState>
  </Model>
  <ListOfTasks>
    ...
    <Task key="Task_16" name="Scan" type="scan" scheduled="true" updateModel="0">
      <Report append="0" target="c:\users\finn\heinlab\hein_modules\chem_model\src\chem_model\local_copasi\temp\fitting\Fit1\results\optimization\results1.txt" reference="Report_78" confirmOverwrite="0"/>
      <Problem>
        <Parameter name="Subtask" type="unsignedInteger" value="5"/>
        <ParameterGroup name="ScanItems">
        <ParameterGroup name="ScanItem"><Parameter type="unsignedInteger" name="Number of steps" value="10"/><Parameter type="unsignedInteger" name="Type" value="0"/><Parameter type="cn" name="Object" value="CN=Root,Model=NoName,Vector=Compartments[default_compartment],Vector=Metabolites[A],Reference=InitialConcentration"/></ParameterGroup></ParameterGroup>
      ...
      <Problem>
        ...
        <ParameterGroup name="OptimizationItemList">
          <ParameterGroup name="FitItem">
            ...
            <Parameter type="cn" name="LowerBound" value="1e-05"/>
            <Parameter type="cn" name="UpperBound" value="10000000.0"/>
            <Parameter type="float" name="StartValue" value="49941.0"/>
            <Parameter type="cn" name="ObjectCN" value="CN=Root,Model=NoName,Vector=Values[k1],Reference=InitialValue"/>
          </ParameterGroup>
          <ParameterGroup name="FitItem">
            <ParameterGroup name="Affected Experiments"/>
            <ParameterGroup name="Affected Cross Validation Experiments"/>
            <Parameter type="cn" name="LowerBound" value="1e-05"/>
            <Parameter type="cn" name="UpperBound" value="10000000.0"/>
            <Parameter type="float" name="StartValue" value="79097.0"/>
            <Parameter type="cn" name="ObjectCN" value="CN=Root,Model=NoName,Vector=Values[kN1],Reference=InitialValue"/>
          </ParameterGroup>
          <ParameterGroup name="FitItem">
            <ParameterGroup name="Affected Experiments"/>
            <ParameterGroup name="Affected Cross Validation Experiments"/>
            <Parameter type="cn" name="LowerBound" value="1e-05"/>
            <Parameter type="cn" name="UpperBound" value="10000000.0"/>
            <Parameter type="float" name="StartValue" value="74286.0"/>
            <Parameter type="cn" name="ObjectCN" value="CN=Root,Model=NoName,Vector=Values[k2],Reference=InitialValue"/>
          </ParameterGroup>
          <ParameterGroup name="FitItem">
            <ParameterGroup name="Affected Experiments"/>
            <ParameterGroup name="Affected Cross Validation Experiments"/>
            <Parameter type="cn" name="LowerBound" value="1e-05"/>
            <Parameter type="cn" name="UpperBound" value="10000000.0"/>
            <Parameter type="float" name="StartValue" value="16290.0"/>
            <Parameter type="cn" name="ObjectCN" value="CN=Root,Model=NoName,Vector=Values[kN2],Reference=InitialValue"/>
          </ParameterGroup>
          <ParameterGroup name="FitItem">
            <ParameterGroup name="Affected Experiments"/>
            <ParameterGroup name="Affected Cross Validation Experiments"/>
            <Parameter type="cn" name="LowerBound" value="1e-05"/>
            <Parameter type="cn" name="UpperBound" value="10000000.0"/>
            <Parameter type="float" name="StartValue" value="31655.0"/>
            <Parameter type="cn" name="ObjectCN" value="CN=Root,Model=NoName,Vector=Values[k3],Reference=InitialValue"/>
          </ParameterGroup>
          <ParameterGroup name="FitItem">
            <ParameterGroup name="Affected Experiments"/>
            <ParameterGroup name="Affected Cross Validation Experiments"/>
            <Parameter type="cn" name="LowerBound" value="1e-05"/>
            <Parameter type="cn" name="UpperBound" value="10000000.0"/>
            <Parameter type="float" name="StartValue" value="49340.0"/>
            <Parameter type="cn" name="ObjectCN" value="CN=Root,Model=NoName,Vector=Values[kN3],Reference=InitialValue"/>
          </ParameterGroup>
        </ParameterGroup>
        <ParameterGroup name="OptimizationConstraintList">
        </ParameterGroup>
        ...
        <ParameterGroup name="Experiment Set">
          <ParameterGroup name="rct2_5">
            <Parameter type="key" name="Key" value="Experiment_rct2_5"/>
            <Parameter type="file" name="File Name" value="c:\users\finn\heinlab\hein_modules\chem_model\src\chem_model\local_copasi\temp\input\rct2_5.csv"/>
            <Parameter type="bool" name="Data is Row Oriented" value="1"/>
            <Parameter type="unsignedInteger" name="First Row" value="1"/>
            <Parameter type="unsignedInteger" name="Last Row" value="41"/>
            ...
            <Parameter type="unsignedInteger" name="Weight Method" value="3"/>
            ...
            <ParameterGroup name="Object Map">
              ...
              <ParameterGroup name="1">
                <Parameter type="cn" name="Object CN" value="CN=Root,Model=NoName,Vector=Compartments[default_compartment],Vector=Metabolites[A],Reference=Concentration"/>
                <Parameter type="unsignedInteger" name="Role" value="2"/>
              </ParameterGroup>
              <ParameterGroup name="2">
                <Parameter type="cn" name="Object CN" value="CN=Root,Model=NoName,Vector=Compartments[default_compartment],Vector=Metabolites[B],Reference=Concentration"/>
                <Parameter type="unsignedInteger" name="Role" value="2"/>
              </ParameterGroup>
              <ParameterGroup name="3">
                <Parameter type="cn" name="Object CN" value="CN=Root,Model=NoName,Vector=Compartments[default_compartment],Vector=Metabolites[P],Reference=Concentration"/>
                <Parameter type="unsignedInteger" name="Role" value="2"/>
              </ParameterGroup>
              <ParameterGroup name="4">
                <Parameter type="cn" name="Object CN" value="CN=Root,Model=NoName,Vector=Compartments[default_compartment],Vector=Metabolites[cat],Reference=Concentration"/>
                <Parameter type="unsignedInteger" name="Role" value="2"/>
              </ParameterGroup>
              <ParameterGroup name="5">
                <Parameter type="cn" name="Object CN" value="CN=Root,Model=NoName,Vector=Compartments[default_compartment],Vector=Metabolites[A],Reference=InitialConcentration"/>
                <Parameter type="unsignedInteger" name="Role" value="1"/>
              </ParameterGroup>
              <ParameterGroup name="6">
                <Parameter type="cn" name="Object CN" value="CN=Root,Model=NoName,Vector=Compartments[default_compartment],Vector=Metabolites[B],Reference=InitialConcentration"/>
                <Parameter type="unsignedInteger" name="Role" value="1"/>
              </ParameterGroup>
              <ParameterGroup name="7">
                <Parameter type="cn" name="Object CN" value="CN=Root,Model=NoName,Vector=Compartments[default_compartment],Vector=Metabolites[P],Reference=InitialConcentration"/>
                <Parameter type="unsignedInteger" name="Role" value="1"/>
              </ParameterGroup>
              <ParameterGroup name="8">
                <Parameter type="cn" name="Object CN" value="CN=Root,Model=NoName,Vector=Compartments[default_compartment],Vector=Metabolites[cat],Reference=InitialConcentration"/>
                <Parameter type="unsignedInteger" name="Role" value="1"/>
              </ParameterGroup>
            </ParameterGroup>
          </ParameterGroup>
          <ParameterGroup name="rct2_4">
            <Parameter type="key" name="Key" value="Experiment_rct2_4"/>
            <Parameter type="file" name="File Name" value="c:\users\finn\heinlab\hein_modules\chem_model\src\chem_model\local_copasi\temp\input\rct2_4.csv"/>
            <Parameter type="bool" name="Data is Row Oriented" value="1"/>
            <Parameter type="unsignedInteger" name="First Row" value="1"/>
            <Parameter type="unsignedInteger" name="Last Row" value="41"/>
            <Parameter type="unsignedInteger" name="Experiment Type" value="1"/>
          ...
          <ParameterGroup name="rct2_3">
            <Parameter type="key" name="Key" value="Experiment_rct2_3"/>
            <Parameter type="file" name="File Name" value="c:\users\finn\heinlab\hein_modules\chem_model\src\chem_model\local_copasi\temp\input\rct2_3.csv"/>
            <Parameter type="bool" name="Data is Row Oriented" value="1"/>
            <Parameter type="unsignedInteger" name="First Row" value="1"/>
            <Parameter type="unsignedInteger" name="Last Row" value="41"/>
            <Parameter type="unsignedInteger" name="Experiment Type" value="1"/>
          ...
          <ParameterGroup name="rct2_2">
            <Parameter type="key" name="Key" value="Experiment_rct2_2"/>
            <Parameter type="file" name="File Name" value="c:\users\finn\heinlab\hein_modules\chem_model\src\chem_model\local_copasi\temp\input\rct2_2.csv"/>
            <Parameter type="bool" name="Data is Row Oriented" value="1"/>
            <Parameter type="unsignedInteger" name="First Row" value="1"/>
            <Parameter type="unsignedInteger" name="Last Row" value="41"/>
            <Parameter type="unsignedInteger" name="Experiment Type" value="1"/>
          ...
          <ParameterGroup name="rct2_1">
            <Parameter type="key" name="Key" value="Experiment_rct2_1"/>
            <Parameter type="file" name="File Name" value="c:\users\finn\heinlab\hein_modules\chem_model\src\chem_model\local_copasi\temp\input\rct2_1.csv"/>
            <Parameter type="bool" name="Data is Row Oriented" value="1"/>
            <Parameter type="unsignedInteger" name="First Row" value="1"/>
            <Parameter type="unsignedInteger" name="Last Row" value="41"/>
            <Parameter type="unsignedInteger" name="Experiment Type" value="1"/>
          ...
          <ParameterGroup name="rct1_5">
            <Parameter type="key" name="Key" value="Experiment_rct1_5"/>
            <Parameter type="file" name="File Name" value="c:\users\finn\heinlab\hein_modules\chem_model\src\chem_model\local_copasi\temp\input\rct1_5.csv"/>
            <Parameter type="bool" name="Data is Row Oriented" value="1"/>
            <Parameter type="unsignedInteger" name="First Row" value="1"/>
            <Parameter type="unsignedInteger" name="Last Row" value="41"/>
            <Parameter type="unsignedInteger" name="Experiment Type" value="1"/>
          ...
          <ParameterGroup name="rct1_4">
            <Parameter type="key" name="Key" value="Experiment_rct1_4"/>
            <Parameter type="file" name="File Name" value="c:\users\finn\heinlab\hein_modules\chem_model\src\chem_model\local_copasi\temp\input\rct1_4.csv"/>
            <Parameter type="bool" name="Data is Row Oriented" value="1"/>
            <Parameter type="unsignedInteger" name="First Row" value="1"/>
            <Parameter type="unsignedInteger" name="Last Row" value="41"/>
            <Parameter type="unsignedInteger" name="Experiment Type" value="1"/>
          ...
          <ParameterGroup name="rct1_3">
            <Parameter type="key" name="Key" value="Experiment_rct1_3"/>
            <Parameter type="file" name="File Name" value="c:\users\finn\heinlab\hein_modules\chem_model\src\chem_model\local_copasi\temp\input\rct1_3.csv"/>
            <Parameter type="bool" name="Data is Row Oriented" value="1"/>
            <Parameter type="unsignedInteger" name="First Row" value="1"/>
            <Parameter type="unsignedInteger" name="Last Row" value="41"/>
            <Parameter type="unsignedInteger" name="Experiment Type" value="1"/>
          ...
          <ParameterGroup name="rct1_2">
            <Parameter type="key" name="Key" value="Experiment_rct1_2"/>
            <Parameter type="file" name="File Name" value="c:\users\finn\heinlab\hein_modules\chem_model\src\chem_model\local_copasi\temp\input\rct1_2.csv"/>
            <Parameter type="bool" name="Data is Row Oriented" value="1"/>
            <Parameter type="unsignedInteger" name="First Row" value="1"/>
            <Parameter type="unsignedInteger" name="Last Row" value="41"/>
            <Parameter type="unsignedInteger" name="Experiment Type" value="1"/>
          ...
          <ParameterGroup name="rct1_1">
            <Parameter type="key" name="Key" value="Experiment_rct1_1"/>
            <Parameter type="file" name="File Name" value="c:\users\finn\heinlab\hein_modules\chem_model\src\chem_model\local_copasi\temp\input\rct1_1.csv"/>
            <Parameter type="bool" name="Data is Row Oriented" value="1"/>
            <Parameter type="unsignedInteger" name="First Row" value="1"/>
            <Parameter type="unsignedInteger" name="Last Row" value="41"/>
            <Parameter type="unsignedInteger" name="Experiment Type" value="1"/>
  ...
  <ListOfReports>
    ...
    <Report precision="6" separator="&#9;" name="multi_parameter_estimation" key="Report_78" taskType="parameterFitting">
      <Comment/>
      <Table printTitle="1">
        <Object cn="CN=Root,Vector=TaskList[Parameter Estimation],Problem=Parameter Estimation,Reference=Best Parameters"/>
        <Object cn="CN=Root,Vector=TaskList[Parameter Estimation],Problem=Parameter Estimation,Reference=Best Value"/>

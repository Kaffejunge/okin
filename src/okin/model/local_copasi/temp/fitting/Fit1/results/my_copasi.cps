<COPASI xmlns="http://www.copasi.org/static/schema" versionMajor="4" versionMinor="34" versionDevel="251" copasiSourcesModified="0">
  ...
  <ListOfTasks>
    ...
    <Task key="Task_16" name="Scan" type="scan" scheduled="true" updateModel="0">
      <Report append="0" target="c:\users\finn\heinlab\hein_modules\chem_model\src\chem_model\local_copasi\temp\fitting\Fit1\results\optimization\results0.txt" reference="Report_78" confirmOverwrite="0"/>
      <Problem>
